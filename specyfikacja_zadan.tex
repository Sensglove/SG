...
Dane odbierane będą w postaci stringa z zakodowanymi heksadecymalnie wartosciami odczytu z kolejnych czuników. Do sprawdzenia poprawnosci przesyłu wykorzystana będzie suma kontrolna.
\subsubsection{Kryteria ewaluacji}
...
\item przesyłanie danych za pomocą socketu
\end{itemize}
Małgorzata Witka-Jeżewska:
\begin{itemize}
